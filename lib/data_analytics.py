...
df = pd.read_csv("C:\\Users\\allan\\Documents\\cpr-feedback\\lib\\testing.csv")
...
output_path = os.path.join(output_directory, 'm{}-d{}-v{}.png'.format(datetime.now().month, datetime.now().day, graph_number))
